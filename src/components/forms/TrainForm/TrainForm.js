...
const TrainForm = ({ setTrainData, smaData }) => {
  const callback = (epoch, log) => console.log(epoch, log)
  const onSubmit = ({ trainingSize, epochs, learningRate, hiddenLayers }) => {
    ...
    const result = trainModel(inputs, outputs, windowSize, epochs, learningRate, hiddenLayers, callback)
